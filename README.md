...
*This is a sample of the XChinaCity4. If you want to obtain the complete data in advance, please send an email to 2250501026@cnu.edu.cn.
...
*此项目仅包含数据集的部分样例，如果您希望提前获取完整数据，请发送邮件至2250501026@cnu.edu.cn。
